...
const autenticar = async (req, res) => {
  ...
  if (await usuario.comprobarPassword(password)) {
    //el password que paso por parametro a la funcion, es el que saco de req-body (lo traido de postman)
    res.json({
      _id: usuario._id,
...
const confirmar = async (req, res) => {
  ...
  try {
    ...
    usuarioConfirmar.token = ""; //asi que se elimina dejandolo vacio
    await usuarioConfirmar.save(); //se hace para ya guardar los cambios en la db de mongo
